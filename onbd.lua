...
table.insert(getgenv().Polaroid_Connections, renderSteppedConnection)
...
table.insert(getgenv().Polaroid_Connections, renderSteppedSilentAimConnection)
...
table.insert(getgenv().Polaroid_Connections, inputBeganConnection)
...
table.insert(getgenv().Polaroid_Connections, renderSteppedCamlockConnection)
...
table.insert(getgenv().Polaroid_Connections, characterAddedConnection)
